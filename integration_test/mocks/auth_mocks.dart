...
class MockAuthService extends GetxService implements AuthService {
  ...
  String? registerResult; // null = success, String = error message
  ...
  void configureRegisterSuccess() {
    registerResult = null; // null = success
  }

  void configureRegisterFailure([String? message]) {
  ...
  Future<AuthResult> login() async {
    ...
    // Call GoogleAuthService.signInWithGoogle() to populate currentUser
    // This mirrors the real AuthService.login() behavior
    final googleAuthService = Get.find<GoogleAuthService>();
    final userCredential = await googleAuthService.signInWithGoogle();

    // Handle cancelled sign-in (user cancelled the Google dialog)
    ...
    if (result.success) {
      ...
      _userEmail = googleAuthService.currentUser?.email ?? 'test@example.com';
    }
  ...
  Future<String?> registerUser({
    ...
    // null means success, non-null String means error message
    ...
    return registerResult; // null = success, String = error message
  }
