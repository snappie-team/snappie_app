...
''');
  ...
  // ==========================================================================
  // Group 3: Sign Up Button Flow Tests
  // ==========================================================================
  ...
  // ==========================================================================
  // Group 4: New User Registration Flow Tests
  // ==========================================================================
  ...
  group('Error Handling', () {
    testWidgets('should handle Google Sign-In cancellation gracefully',
      ...
      expect(testSetup.mockGoogleAuthService.signInCallCount, 1);
      // Login was called once but returned fail early due to cancellation
      expect(testSetup.mockAuthService.loginCallCount, 1);
    });
  ...
  group('Edge Cases', () {
    testWidgets('should handle exception during Google Sign-In',
      ...
      // Wait for error handling and snackbar to appear/disappear
      await tester.pump(const Duration(seconds: 2));
      await robot.clearOverlays();

      // Should still be on login page - check with a more lenient finder
    ...
    testWidgets('should validate username format requirements',
      ...
      // Clear any leftover overlays from previous tests
      await robot.clearOverlays();
      ...
      if (nextButton.evaluate().isNotEmpty) {
        ...
        final buttonWidget = tester.widget<Widget>(nextButton);
  ...
  // ==========================================================================
  // Group 7: Destructive Tests (Run last to avoid side effects)
  // ==========================================================================
  group('Destructive Tests', () {
